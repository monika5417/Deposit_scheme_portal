...
@Api(value = "SchemeTypeController", description = "Rest api for Scheme Type.")
@RestController
@RequestMapping(RestApiUrl.SCHEME_TYPE_API)
public class SchemeTypeController {

	Logger LOG = LoggerFactory.getLogger(SchemeTypeController.class);

	@Autowired
	private SchemeTypeService schemeTypeService;

	@ApiOperation(value = "Save Scheme Type details", notes = "Pass Scheme Type Name", response = Response.class, responseContainer = "List", tags = RestApiUrl.SCHEME_TYPE_TAGS)
	@ApiResponses(value = {
	...
	@ApiOperation(value = "Retrieve all Scheme Type", notes = "Fetch all Scheme Type", response = Response.class, responseContainer = "List", tags = RestApiUrl.SCHEME_TYPE_TAGS)
	@ApiResponses(value = {
	...
	public ResponseEntity<Response<?>> retrieveAllSchemeType(HttpServletResponse httpServletResponse)
		...
		final String method = RestApiUrl.SCHEME_TYPE_API + RestApiUrl.GET_ALL_URL + " : retrieveAllSchemeType()";
		LOG.info(method);
