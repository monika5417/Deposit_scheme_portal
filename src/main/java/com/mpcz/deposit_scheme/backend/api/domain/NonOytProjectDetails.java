...
@Entity
@Table(name = "NON_OYT_PROJECT_DETAILS")
public class NonOytProjectDetails extends Auditable<Long> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6714316696054562168L;

	@Id
	@SequenceGenerator(name = "NON_OYT_PROJECT_DETAILS_SEQ", sequenceName = "NON_OYT_PROJECT_DETAILS_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "NON_OYT_PROJECT_DETAILS_SEQ")
    private Long id;
