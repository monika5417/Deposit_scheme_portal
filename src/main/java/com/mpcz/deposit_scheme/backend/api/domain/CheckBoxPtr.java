...
@Table(name = "Check_Box_Ptr")
@Entity(name = "CheckBoxPtr")
@NoArgsConstructor
@AllArgsConstructor
public @Data class CheckBoxPtr {
	
	@Id
	@SequenceGenerator(name = "Check_Box_Ptr_SEQ", sequenceName = "Check_Box_Ptr_SEQ",allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "Check_Box_Ptr_SEQ")
    ...
    @Column(name = "check_box_24")
    private String checkBox24;

    @Column(name = "check_box_25")
    private String checkBox25;

    @Column(name = "check_box_26")
    private String checkBox26;

    @Column(name = "check_box_27")
    private String checkBox27;

    @Column(name = "check_box_28")
    private String checkBox28;

    @Column(name = "check_box_29")
    private String checkBox29;

    @Column(name = "check_box_30")
