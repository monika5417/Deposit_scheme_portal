...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	private static final String[] PUBLIC_MATCHERS = { "/images/*", "/resources/static/*", "/v2/api-docs",
			...
			"/api/user/consumer-application/getAllPaginate/", "/ReSampling/post-resample-data","/ReSampling/post-resample-data1",
			"/ReSampling/safling-data-by-autenotication-ID/{authenticationId}",
			...
			"/GatePassChallan/save","/ReSampling/uploadPhotoDtr","/ReSampling/getSampleDataForConsuemrAppliationDetailTableByConsumerApplicaionNo/{consumerApplicaionNO}",
//			charitra
		...
		"/api/consumer/consumer-application/changeMobileNOByApplicationisGOV/{oldMobileNo}/{newMobileNo}",
			...
			"/GatePassChallan/saveReversiveGetPassPdfaAndtrfUploadFile",
			"/GatePassChallan/nistha-lab-TA-submit-data",
			"/ReSampling/getReSampleData/{consumerApplicationNo}",
			"/ReSampling/getDtrValue/{consumerApplicationNo}",
			"/api/refundAmount/saveDataForRefundMaterialZeroOneCase",
			"/api/refundAmount/upload-pdf-for-refund-data",
...
//			"/api/consumer/bill-desk/Billdesk_payment_refundDemandAmount",
			"/api/consumer/dc/get/{id}",
			"/GatePassChallan/saveGetPassPdf",
			...
			// end
			"/GatePassChallan/save",
			"/ReSampling/getsempleSelectedAndTestingDoneData",
			"/ReSampling/getselectTestingData",
			"/api/user/erp//getoytMaterial/{consumerApplicationNo}",
			"/ReSampling/safling-data-by-Vendor-table-autenotication-ID/{authenticationId}",
			"/user-tkoen/token", "/api/consumer/payment/response_payment", "/api/consumer/payment/sendReciept",
...
//			"/api/refundAmount/user/changeRefundApplicationStatusToFinalStage/{consumerApplicationNo}",
			...
			"/vendor_add_materials/consumer/updateVendorMaterialData",
			"/Db_Link_Erp_Controller/saveSupplierData",
			...
			"/api/user/login/getUserByUserId/{userId}",
			"/api/user/save-work-order/uploadDraftAgreement",
...
//			procedure call api
			"/procedure/createInvoiceProcedure",
			"/mis_details/getFinancePaymentDataForGSTApplication/{yearMonth}",
