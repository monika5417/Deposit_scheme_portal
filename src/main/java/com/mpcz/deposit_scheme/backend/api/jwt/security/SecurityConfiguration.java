...
//			"/ReSampling/getSampleDataForReSamplingTable/{flagNo}",
			...
			"/ReSampling/getSampleDataForConsuemrAppliationDetailTable1/{dcid}", "/nistha-lab/testing-report-upload",
...
//			"/api/consumer/bill-desk/Billdesk_payment_refundDemandAmount",
			...
			// Monika API Start
"/api/consumer/consumer-details/generateDynamicExcel",
...
//			"/api/refundAmount/user/changeRefundApplicationStatusToFinalStage/{consumerApplicationNo}",
			...
			"/api/consumer/qc-portal/getRcaFromThirdParty/{circleId}/{consumerApplicationNumber}",
			"/api/refundAmount/user/financeAoAcceptanceAfterErpCompletion",
			"/NgbStagingData/getOytDataForTemporaryConnection/{consumerAppNo}", "/NgbStagingData/pdc//{ivrsNo}",
			"/api/consumer/dc/getDcDataByNgbDCCode/{ngbDcCode}", "/mis_details/execute-query", "/api/erp-estimate/save",
			"/api/erp-estimate/getEstimateQty/{consumerApplicationNo}",
			"/api/user/erp/nonOytMaterialCharges/{erpNo}/{consumerApplicationNo}",
			"/api/adminChangable/user/changeDescriptionOfWork",
			"/api/user/erp/getClientIp",
...
//			procedure call api
			...
			"/mis_details/getPaymentDetailsExcel", "/api/hello", "/api/payment", "/api/paymentsss", "/api/data",
			"/mis_details/fetchRecords/{tableName}/{propertyName}/{consumerApplicationNo}",
			...
			"/getData",
			"/getAllApplicationByApplicationStatusByUserIdAndDC/{applicationStatusId}/{userId}/{dcId}/{divisionId}/{schemeTypeIds}",
//			bhanu sir
			...
			"/api/user/application-survey/get/{id}", "/procedure/send/{appNo}", "/oyt14/updatby",
