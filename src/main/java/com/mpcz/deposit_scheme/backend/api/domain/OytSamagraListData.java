...
@Entity(name = "OytSamagraListData")
@Table(name = "OYT_SAMAGRA_LIST")
public class OytSamagraListData {

	@Id
	@SequenceGenerator(name = "OYT_SAMAGRA_LIST_SEQ", sequenceName = "OYT_SAMAGRA_LIST_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "OYT_SAMAGRA_LIST_SEQ")
