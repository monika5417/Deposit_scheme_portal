...
@Table(name = "Check_Box_Dtr")
@Entity(name = "CheckBoxDtr")
@NoArgsConstructor
@AllArgsConstructor
public @Data class CheckBoxDtr {
	
	@Id
	@SequenceGenerator(name = "Check_Box_Dtr_SEQ", sequenceName = "Check_Box_Dtr_SEQ",allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "Check_Box_Dtr_SEQ")
