...
import com.mpcz.deposit_scheme.backend.api.request.FeederForm;
...
@Api(value = "FeederController", description = "Rest api for feeder master")
@RestController
@RequestMapping(RestApiUrl.FEEDER_API)
public class FeederController {

	Logger LOG = LoggerFactory.getLogger(FeederController.class);
	...
	@ApiOperation(value = "Save feeder detaiils", notes = "Pass feeder name, code & substation id", response = Response.class, responseContainer = "List"
	...
	public ResponseEntity<Response<?>> addFeeder(@RequestBody @Valid FeederForm feederForm, BindingResult bindingResult,
			HttpServletResponse httpServletResponse)
					throws FormValidationException, InvalidAuthenticationException, FeederException, SubstationException {

		 final String method = RestApiUrl.FEEDER_API + RestApiUrl.ADD_URL + " : addFeeder()";
		 LOG.info(method);
		Response<Feeder> response = null;
		...
		feeder.setFeederName(feederForm.getFeederName());
		feeder.setFeederCode(feederForm.getFeederCode());

		Substation substation = substationService.findSubstationById(feederForm.getSubstationId());
		feeder.setFeederSubstation(substation);

		response = feederService.save(feeder);

		return ResponseEntity.ok().header(ResponseMessage.APPLICATION_TYPE_JSON).body(response);
	}

	@ApiOperation(value = "Delete feeder information", notes = "Pass feeder id", response = Response.class, responseContainer = "List"
			 , tags = RestApiUrl.FEEDER_TAGS
			)
	@ApiResponses(value = {
	...
	public ResponseEntity<Response<?>> removeFeeder(@PathVariable long id, HttpServletResponse httpServletResponse)
			throws FormValidationException, InvalidAuthenticationException, FeederException {

		// final String method = RestApiUrl.FEEDER_API + RestApiUrl.DELETE_URL + " : removeFeeder()";
		// LOG.info(method);
		Response<Feeder> response = null;

		response = feederService.delete(id);

		return ResponseEntity.ok().header(ResponseMessage.APPLICATION_TYPE_JSON).body(response);
	}

	@ApiOperation(value = "Update feeder information", notes = "Pass feeder name,  code, id &  substaton id", response = Response.class, responseContainer = "List"
			 , tags = RestApiUrl.FEEDER_TAGS
			)
	@ApiResponses(value = {
	...
	public ResponseEntity<Response<?>> updateFeeder(@RequestBody @Valid FeederForm feederForm,
			BindingResult bindingResult, @PathVariable long id, HttpServletResponse httpServletResponse)
					throws FormValidationException, InvalidAuthenticationException, FeederException, SubstationException {

		 final String method = RestApiUrl.FEEDER_API + RestApiUrl.UPDATE_URL + " : updateFeeder()";
		 LOG.info(method);
		Response<Feeder> response = null;
		...
		final Feeder feeder = feederService.findFeederById(id);
		feeder.setFeederName(feederForm.getFeederName());
		feeder.setFeederCode(feederForm.getFeederCode());
		...
		response = feederService.update(feeder);

		return ResponseEntity.ok().header(ResponseMessage.APPLICATION_TYPE_JSON).body(response);
	}

	@ApiOperation(value = "Retrieve specific feeder", notes = "Pass feeder id", response = Response.class, responseContainer = "List"
			// , tags = RestApiUrl.FEEDER_TAGS
			)
	@ApiResponses(value = {
	...
	public ResponseEntity<Response<?>> retrieveFeeder(@PathVariable long id, HttpServletResponse httpServletResponse)
		 ...
		 final String method = RestApiUrl.FEEDER_API + RestApiUrl.GET_URL + " : retrieveFeeder()";
		 LOG.info(method);
		Response<Feeder> response = feederService.findById(id);
		return ResponseEntity.ok().header(ResponseMessage.APPLICATION_TYPE_JSON).body(response);
	...
	public ResponseEntity<Response<?>> retrieveAllFeeder(HttpServletResponse httpServletResponse)
			throws FormValidationException, InvalidAuthenticationException, FeederException {

		// final String method = RestApiUrl.FEEDER_API + RestApiUrl.GET_ALL_URL + " : retrieveAllFeeder()";
		// LOG.info(method);
		Response<List<Feeder>> response = feederService.findAll();
		return ResponseEntity.ok().header(ResponseMessage.APPLICATION_TYPE_JSON).body(response);
	}

	@ApiOperation(value = "Retrieve all feeders by substation", notes = "Pass substation id", response = Response.class, responseContainer = "List"
			 , tags = RestApiUrl.FEEDER_TAGS
			)
	@ApiResponses(value = {
			@ApiResponse(code = ApiResponseCode.SUCCESS_CODE, message = ResponseMessage.RECORD_FETCH_ALL_MESSAGE),
	...
	public ResponseEntity<Response<?>> retrieveAllFeedersBySubstation(@PathVariable long id,
		 ...
		 final String method = RestApiUrl.FEEDER_API + RestApiUrl.GET_ALL_FEEDER_BY_SUBSTATION_URL
