...
@Table(name = "Check_Box_Lt")
@Entity(name = "CheckBoxLt")
@NoArgsConstructor
@AllArgsConstructor
public @Data class CheckBoxLt {
	
	@Id
	@SequenceGenerator(name = "Check_Box_Lt_SEQ", sequenceName = "Check_Box_Lt_SEQ",allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "Check_Box_Lt_SEQ")
