...
public class ConnectionPradayServiceImpl implements ConnectionPradayService {
	...
	public ResponseEntity<Response> saveConnectionPraday(ConnectionPraday connectionPraday) {
		...
		try {
			ConsumerApplicationDetail findByConsumerApplicationNumber = consumerApplictionDetailRepository.findByConsumerApplicationNumber(connectionPraday.getConsumerApplicationNo());
