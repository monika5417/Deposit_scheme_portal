...
//	                     value 1 mtlb demand note refund krna hai
	                  ...
	                  if (save != null) {
	                     findByConsumerApplicationNumber.setApplicationStatus((ApplicationStatus)this.applicationStatusRepository.findById(ApplicationStatusEnum.REFUND_PROPOSAL_BY_DGM.getId()).get());
	                     this.consumerApplictionDetailRepository.save(findByConsumerApplicationNumber);
