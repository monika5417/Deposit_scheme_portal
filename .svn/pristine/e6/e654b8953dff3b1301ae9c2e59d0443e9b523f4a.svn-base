...
//			Upload aadharUpload = null;
//			Upload panUpload = null;
//			Upload electricityBillUpload = null;
//			Upload residentialProofUpload = null;
...
//			if (consumerSignUpForm.getIvrsNo() == null || consumerSignUpForm.getIvrsNo().equals("")) {
//
//				response.setCode(HttpCode.NULL_OBJECT);
//				response.setMessage("Please fill IVRS No");
//				throw new ConsumerException(response);
//			}
...
//			if (consumerSignUpForm.getAadharNo() == null || consumerSignUpForm.getAadharNo().equals("")) {
//
//				response.setCode(HttpCode.NULL_OBJECT);
...
//			}
//
//			if (consumerSignUpForm.getPanNo() == null || consumerSignUpForm.getPanNo().equals("")) {
//
//				response.setCode(HttpCode.NULL_OBJECT);
//				response.setMessage("Please fill Pan No");
//				throw new ConsumerException(response);
//			}

//			if (consumerSignUpForm.getConsumerTypeId() == null
//					|| consumerSignUpForm.getConsumerTypeId().compareTo(0l) <= 0) {
//				response.setCode(HttpCode.NULL_OBJECT);
//				response.setMessage("Please select Consumer Type");
//				throw new ConsumerException(response);
//			}

//			if (docAadhar == null) {
//				response.setCode(HttpCode.NULL_OBJECT);
//				response.setMessage("Please upload Aadhar Document");
//				throw new ConsumerException(response);
//			}
//
//			if (docPan == null) {
//				response.setCode(HttpCode.NULL_OBJECT);
//				response.setMessage("Please upload Pan Document");
//				throw new ConsumerException(response);
//			}
//
//			if (docResidentialProof == null) {
//				response.setCode(HttpCode.NULL_OBJECT);
//				response.setMessage("Please upload Residential Proof Document");
//				throw new ConsumerException(response);
//			}

//			if (docElectricityBill == null) {
//				response.setCode(HttpCode.NULL_OBJECT);
//				response.setMessage("Please upload Electricity Bill Document");
//				throw new ConsumerException(response);
//			}
			/*********** validations ends ************************/

//			if (docAadhar != null) {
//				aadharUpload = uploadService.uploadFile(docAadhar, "AADHAR_CARD");
//			}
//
//			if (docPan != null) {
//				panUpload = uploadService.uploadFile(docPan, "PAN_CARD");
//			}

//			if (docResidentialProof != null) {
//				electricityBillUpload = uploadService.uploadFile(docResidentialProof, "RESIDENTIAL_PROOF");
//			}

//			if (docElectricityBill != null) {
//				residentialProofUpload = uploadService.uploadFile(docElectricityBill, "ELECTRICITY_BILL");
//			}
//
//			Consumer findByConsumerMobileNo = consumerRepository
//					.findByConsumerMobileNo(consumerSignUpForm.getConsumerMobileNo()).get();
//
//			if (findByConsumerMobileNo!=null) {
//				response.setCode(HttpCode.NULL_OBJECT);
//				response.setMessage("Please fill Password");
//				throw new ConsumerException(response);
//			}
...
//			consumer.setIvrsNo(consumerSignUpForm.getIvrsNo().trim());
...
//
//				try {
//					ConsumerType consumerType = consumerTypeService
//							.findByConsumerTypeId(consumerSignUpForm.getConsumerTypeId());
//
...
//			}
			...
			// consumer.setAadharNo(consumerSignUpForm.getAadharNo().trim());
			// consumer.setDocAadhar(aadharUpload);
			// consumer.setPanNo(consumerSignUpForm.getPanNo().trim());
			// consumer.setDocPan(panUpload);
			// consumer.setDocElectricityBill(electricityBillUpload);
			// consumer.setDocResidentialProof(residentialProofUpload);
