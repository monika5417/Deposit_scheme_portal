...
//Dto for sending data to SSP Portal

public class NgbStagingDto {
	...
	public String toString() {
		return "NgbStagingDto [locationCode=" + locationCode + ", applicationNumber=" + applicationNumber
				...
				+ address2 + ", address3=" + address3 + ", primaryMobileNo=" + primaryMobileNo + ", aadhaarNo="
				+ aadhaarNo + ", tariffCategory=" + tariffCategory + ", connectionType=" + connectionType
				+ ", meteringStatus=" + meteringStatus + ", premiseType=" + premiseType + ", sanctionedLoad="
				+ sanctionedLoad + ", sanctionedLoadUnit=" + sanctionedLoadUnit + ", contractDemand=" + contractDemand
				+ ", contractDemandUnit=" + contractDemandUnit + ", isSeasonal=" + isSeasonal
				+ ", purposeOfInstallationId=" + purposeOfInstallationId + ", purposeOfInstallation="
				+ purposeOfInstallation + ", tarrifCode=" + tarrifCode + ", subCategoryCode=" + subCategoryCode
				+ ", phase=" + phase + ", tcStartDate=" + tcStartDate + ", tcEndDate=" + tcEndDate + ", isGovernment="
				+ isGovernment + ", plotSize=" + plotSize + ", plotSizeUnit=" + plotSizeUnit + ", isXray=" + isXray
				+ ", isWeldingTransformerSurcharge=" + isWeldingTransformerSurcharge + ", isCapacitorSurcharge="
				+ isCapacitorSurcharge + ", isDemandside=" + isDemandside + ", isiMotorType=" + isiMotorType
				+ ", isBeneficiary=" + isBeneficiary + ", dtrName=" + dtrName + ", poleNo=" + poleNo + ", poleLatitude="
				+ poleLatitude + ", poleLongitude=" + poleLongitude + ", feederName=" + feederName + ", poleDistance="
				+ poleDistance + ", areaStatus=" + areaStatus + ", groupNo=" + groupNo + ", readingDiaryNo="
				+ readingDiaryNo + ", dateOfReg=" + dateOfReg + ", registrationFeeAmount=" + registrationFeeAmount
				+ ", registrationFeeAmountMrNo=" + registrationFeeAmountMrNo + ", securityDepositAmount="
				+ securityDepositAmount + ", securityDepositAmountMrNo=" + securityDepositAmountMrNo
				+ ", isAffiliatedConsumer=" + isAffiliatedConsumer + ", affiliatedConsumerNo=" + affiliatedConsumerNo
				+ ", portalName=" + portalName + ", propertyName=" + propertyName + ", propertyValue=" + propertyValue
				+ "]";
	}
