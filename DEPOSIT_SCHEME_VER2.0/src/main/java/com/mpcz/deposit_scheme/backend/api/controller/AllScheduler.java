...
//	@Scheduled(fixedRate = 86400000)               // 5 minute
...
//	                                System.out.println("Contractor did not take the action on application: " + consumerApplicationNo);
//	                                notActionedCount++;
//	                            } else if ("true".equals(isRejected)) {
//	                                System.out.println("The application is rejected by contractor: " + consumerApplicationNo);
//	                                rejectedCount++;
//	                            } else if ("false".equals(isRejected)) {
//	                                acceptedCount++;
//	                                System.out.println("The application is accepted by contractor: " + consumerApplicationNo);
//	                                
...
//	                                String materialInstallationStart = item.optString("material_installation_start", null);
//	                                String materialInstallationFinish = item.optString("material_installation_finished", null);
...
//	                                    System.out.println("Work details available for consumer application: " + consumerApplicationNo);
//	                                    System.out.println(
...
//	                                    contractorForBidWorkStatus.setMaterialInstallFinishDate(materialInstallationFinish);
//	                                    contractorForBidWorkStatus.setMaterialInstallStartDate(materialInstallationStart);
...
//	                                } else {
//	                                    System.out.println("Accepted application has missing dates for consumerApplicationNo: " + consumerApplicationNo);
//	                                }
//	                            }
...
//
//	                    if (!applicationFound) {
//	                        System.out.println("Application not found in tkc/bid_not_participated_docs: " + consumerApplicationNo);
//	                    }
//	                }
//	            } else {
...
//	            }
//
//	            System.out.println("Total applications fetched from DSP Database: " + saveContractorExpectedDates.size());
