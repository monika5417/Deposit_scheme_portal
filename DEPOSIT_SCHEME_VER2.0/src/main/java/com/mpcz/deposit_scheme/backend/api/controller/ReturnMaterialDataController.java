...
public class ReturnMaterialDataController {
	...
	if(returnMaterialDataDto.getReturnMaterialData().isEmpty() && returnMaterialDataDto.getReturnMaterialData()==null ) {
		...
		for(ReturnMaterialData returnMaterialData1 :returnMaterialDataDto.getReturnMaterialData()) {
			 findByConsumerApplicationNumber = consumerApplictionDetailRepository.findByConsumerApplicationNumber(returnMaterialData1.getConsumerApplicationNumber());
