...
@Api(value = "TaskTypeController", description = "Rest api for Task Type.")
@RestController
@RequestMapping(RestApiUrl.TASK_TYPE_API)
public class TaskTypeController {
	...
	@ApiOperation(value = "Save Task Type details", notes = "Pass Task Type Name", response = Response.class, responseContainer = "List", tags = RestApiUrl.TASK_TYPE_TAGS)
	@ApiResponses(value = {
	...
	public ResponseEntity<Response<?>> addTaskType(@RequestBody @Valid TaskTypeForm taskTypeForm,

			BindingResult bindingResult, HttpServletResponse httpServletResponse)
			throws FormValidationException, InvalidAuthenticationException, TaskTypeException {

		System.out.println("addTaskType !!!!!");

		final String method = RestApiUrl.TASK_TYPE_API + RestApiUrl.ADD_URL + " : addTaskType()";
		LOG.info(method);
		...
		TaskType taskType = taskTypeService.saveTaskType(taskTypeForm);

		response.setList(Arrays.asList(taskType));
	...
	@ApiOperation(value = "Retrieve Specific Task Type", notes = "Pass Task Type Id", response = Response.class, responseContainer = "List", tags = RestApiUrl.TASK_TYPE_TAGS)
	@ApiResponses(value = {
	...
	public ResponseEntity<Response<?>> retrieveTaskType(@PathVariable Long id, HttpServletResponse httpServletResponse)
			throws FormValidationException, InvalidAuthenticationException, TaskTypeException {

		System.out.println("retrieveTaskType !!!!!");

		final String method = RestApiUrl.TASK_TYPE_API + RestApiUrl.GET_URL + " : retrieveTaskType()";
		LOG.info(method);

		Response<TaskType> response = new Response<>();

		TaskType taskType = taskTypeService.findByTaskTypeId(id);
	...
	@ApiOperation(value = "Retrieve all Task Type", notes = "Fetch all Task Type", response = Response.class, responseContainer = "List", tags = RestApiUrl.TASK_TYPE_TAGS)
	@ApiResponses(value = {
	...
	public ResponseEntity<Response<?>> retrieveAllTaskType(HttpServletResponse httpServletResponse)
		...
		final String method = RestApiUrl.TASK_TYPE_API + RestApiUrl.GET_ALL_URL + " : retrieveAllTaskType()";
		LOG.info(method);
