...
//		LOG.info(method);
	...
	public Response<PageConsumerApplicationDetailDTO> findAllConsumerApplicationDetailByApplicationStatusPagination( ConsumerApplicationDetailsFilterDTO filterDTO)
		...
		List<ConsumerApplicationDetail> consumerApplicationDetails = findConsumerApplicationDetailByApplicationStatusPaginate(filterDTO);
...
//		List<ConsumerApplicationDetail> consumerApplicationDetailList = consumerApplicationDetails.getContent();
	...
	public List<ConsumerApplicationDetail> findConsumerApplicationDetailByApplicationStatusPaginate(ConsumerApplicationDetailsFilterDTO filterDTO) throws ConsumerApplicationDetailException {
