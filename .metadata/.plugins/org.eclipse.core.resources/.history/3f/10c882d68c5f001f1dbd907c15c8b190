...
@Table(name = "Check_Box_Lt_11")
@Entity(name = "CheckBoxLt11")
@NoArgsConstructor
@AllArgsConstructor
public @Data class CheckBoxLt11 {
	
	@Id
	@SequenceGenerator(name = "Check_Box_Lt_11_SEQ", sequenceName = "Check_Box_Lt_11_SEQ",allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator = "Check_Box_Lt_11_SEQ")
